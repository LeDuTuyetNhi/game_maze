...
//	SetTeColor(13);
//	gotoxy(15, 2);
//	printf("GVHD: Thay Vu Dinh Bao\n ");
//	printf("   Cac thanh vien trong nhom gom:\n  ");
//	printf("1. Phan Chu Ky (nhom truong)\n  ");
//	printf("2. Nguyen Van Ban\n  ");
//	printf("3. Nguyen Vi Hoang\n  ");
//	printf("4. Nguyen Hoang Phuc\n  ");
//	printf("5. Phan Van Loc");
//	SetTeColor(14);
//	char *_ = "%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c";
//	int __ = 3 * *_ + 5;
//	printf("\n\n    \t\t\t");
//	printf("Nguon tham khao tai:\n");
